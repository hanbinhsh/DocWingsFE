                                ...
                                <div class="ibox-content mailbox-content">
                                    <div class="file-manager">
                                        ...
                                        <ul class="category-list" style="padding: 0">
                                            <li><a @click="findFilesByCategory(0)"> <i
                                                        class="fa fa-circle text-navy"></i> 图片</a></li>
                                            <li><a @click="findFilesByCategory(1)"> <i
                                                        class="fa fa-circle text-danger"></i> 文档</a></li>
                                            <li><a @click="findFilesByCategory(3)"> <i
                                                        class="fa fa-circle text-primary"></i> 视频</a></li>
                                            <li><a @click="findFilesByCategory(2)"> <i
                                                        class="fa fa-circle text-info"></i> 音乐</a></li>
                                            <li><a @click="findFilesByCategory(4)"> <i
                                                        class="fa fa-circle text-warning"></i> 其他</a></li>
                                        </ul>
    ...
    methods: {
        ...
        async filePreview(file) {
            ...
            if (file.fileType.startsWith('image/')) {
                ...
                const responseFiles = await axios.get(`/api/findDocxByParentId?parentId=${this.currentFolder.folderId}`);
                console.log(responseFiles)
                this.docx = responseFiles.data.data.docxList  // 更新列表
                let key = 0
                this.docx.forEach((src, index) => {  // 匹配选中
                    if (src.split('=')[1] == file.fileId) {
                        key = index;
                    }
                })
