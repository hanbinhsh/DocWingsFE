  ...
  <div class="about">
    <div class="middle-box text-center loginscreen   animated fadeInDown">
				...
				<div class="ibox-content">
					...
					<form id="form" action="form_wizard.html#" class="wizard-big">
						...
						<fieldset style="margin-top: 100px;margin-left: 10px;">
							<h2>用户协议和隐私政策</h2>
							<input id="acceptTerms" name="acceptTerms" type="checkbox" class="required"> <label for="acceptTerms">我同意<a href="#">用户协议</a>和<a href="#">隐私政策</a></label>
						</fieldset>
						<h1>注册成功</h1>
						<fieldset>
		...
		<div class="text-center loginscreen animated fadeInDown" style="max-width: 500px;margin: 0 auto;">
			...
			<div class="row">
				<div class="col-lg-6"><a class="col-lg-12 btn btn-sm btn-white btn-block" href="login.jsp">登录</a></div>
				<div class="col-lg-6"><a class="col-lg-12 btn btn-sm btn-white btn-block" href="home.jsp">返回首页</a></div>
			</div>
		</div>
  </div>
</template>
